...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*هذا الأمر خاص بصاحب البوت فقط و لن يشتغل معك هذا الأمر لا تحاول معه 😆 هذا حساب صاحب البوت \n instagram.com/noureddine_ouafy \n this cmd is just for owner bot ',
        owner: '*هذا الأمر خاص بصاحب البوت فقط و لن يشتغل معك هذا الأمر لا تحاول معه 😆 هذا حساب صاحب البوت \n instagram.com/noureddine_ouafy \n this cmd is just for owner bot',
        ...
        group: 'عذرا ولكن هذا الأمر خاص بالمجموعات \n وايضا خاص بصاحب البوت فقط \n لن يشتغل معك الامر لا تحاول معه \n تابع صاحب البوت من هنا :\n instagram.com/noureddine_ouafy',
        private: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙽 𝙲𝙷𝙰𝚃 𝙿𝚁𝙸𝚅𝙰𝙳𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        admin: '*معذرة يا صديقي لكن هذا الأمر بأدمين هذه المجموعة وخاص بنورالدين فقط لذا لا تحاول مجددا تجربته لانه لن يشتغل معك *',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: 'Follow me here : ', body: 'BOBIZA BOT', thumbnail: imagen1, sourceUrl: 'https://instagram.com/noureddine_ouafy' }}}}, aa)
